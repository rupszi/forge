  ...
  return (
    <div className="relative">
      <textarea
        ...
        disabled={disabled}
        className="w-full h-24 px-4 py-3 rounded-lg bg-[#12121a] border border-[#1e1e2e] text-white placeholder-gray-600 resize-none focus:outline-none focus:border-purple-600 disabled:opacity-50 text-sm"
      />
      <button
